import { FrameworkProperty, DragDropHandler } from "./user-interface.js";
 ...
 */
export declare const JBannerType: Enumeration;
export declare const ButtonIconPosition: Enumeration;
