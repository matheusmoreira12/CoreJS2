...
export class NativeEventWorker extends FrameworkEventWorker {
    constructor() {
        super(...arguments);
        this.bound_nativeEvent_handler = this.nativeEvent_handler.bind(this);
    }
...
class BroadcastFrameworkEventWorker extends FrameworkEventWorker {
    constructor(self) {
        super(self);
        this.routedEvents = new Collection();
...
BroadcastFrameworkEventWorker.EventBroadcastEvent = new FrameworkEvent();
/**
