...
(function (Core) {
    ...
    (function (UserInterface) {
        UserInterface.BindingDirection = new Enumeration({
            Both: 3,
            ToTarget: 1,
            ToSource: 2
        });
        UserInterface.IBindingOptions = new Interface(new InterfaceProperty("direction", Type.get(Number), MemberSelectionAttributes.Any, true), new InterfaceProperty("valueConverter", IValueConverter, MemberSelectionAttributes.Any, true));
        const DEFAULT_BINDING_OPTIONS = {
            direction: UserInterface.BindingDirection.Both,
            valueConverter: null
        };
        ...
        class Binding extends Destructible {
            constructor(options = null) {
                if (options !== null && !Type.of(options).implements(UserInterface.IBindingOptions))
                    throw new ArgumentTypeException("options", Type.of(options), UserInterface.IBindingOptions);
                super(options);
        ...
        class PropertyBindingWorker extends BindingWorker {
            ...
            updateTargetProperty(value) {
                ...
                if (!Enumeration.isFlagSet(UserInterface.BindingDirection.ToTarget, options.direction))
                    return;
            ...
            updateSourceProperty(value) {
                const options = this.getComputedOptions();
                if (!Enumeration.isFlagSet(UserInterface.BindingDirection.ToSource, options.direction))
                    return;
                const valueConverter = options.valueConverter;
                if (valueConverter !== null)
        ...
        UserInterface.PropertyBinding = PropertyBinding;
        ...
        UserInterface.PropertyAttributeBinding = PropertyAttributeBinding;
