...
import { ArgumentTypeException, ArgumentOutOfRangeException } from "./exceptions.js";
...
const GregorianCalendar = {
    ...
    getTime(ticks) {
        ...
        const milli = Math.round(millisFromEpoch % MILLISECONDS_IN_SECOND), sec = secsFromEpoch % SECONDS_IN_MINUTE, min = Math.round(minsFromEpoch % MINUTES_IN_HOUR), hour = Math.round(hoursFromEpoch % HOURS_IN_DAY);
        return {
            millisecond: milli,
            second: sec,
            minute: min,
