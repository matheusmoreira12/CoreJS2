...
class ModuleContext {
    ...
    module(namespace, initializer) {
        return __awaiter(this, void 0, void 0, function* () {
            yield Module.declare(namespace, initializer, this.targetModule);
        });
    }
    import(identifier) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ImportResolver.resolveAll();
            return yield importResolver.resolved;
        });
    }
    importMany(namespace = "", ...names) {
        return __awaiter(this, void 0, void 0, function* () {
            namespace = Identifier.get(namespace);
            let map = {};
            for (let name of names) {
                const identifier = Identifier.get(name);
                map[name] = yield this.import(namespace.combine(identifier));
            }
            return map;
        });
    }
...
export class Module {
    constructor(namespace, initializer, parentModule = null) {
        this.status = Module.STATUS_PENDING;
        namespace = Identifier.get(namespace);
        if (!namespace)
    ...
    static declare(namespace, initializer, parentModule = rootModule) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.initializer.call(globalThis, context);
