...
export class Rectangle extends Shape {
    __initialization() {
        ...
        Blender.execute(this, DependencyObject, o => new PropertyAttributeBinding(o, Shape.strokeThicknessProperty, <Element>this.__PART_rect.domElement, "strokeThickness", null, { direction: BindingDirection.ToTarget, valueConverter: new LengthCSSPropertyConverter() }));

        //Bind properties from Rectangle to SVG Rect attributes
        Blender.execute(this, DependencyObject, o => new PropertyAttributeBinding(o, Rectangle.rxProperty, <Element>this.__PART_rect.domElement, "rx", null, { valueConverter: new LengthCSSPropertyConverter(), direction: BindingDirection.ToTarget }));
