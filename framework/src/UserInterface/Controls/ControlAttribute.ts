...
export class ControlAttribute extends DependencyObject {
    static nameProperty = DependencyProperty.register(ControlAttribute, "name", { valueType: Type.get(String), defaultValue: "" });
    ...
    static valueProperty = DependencyProperty.register(ControlAttribute, "value", { valueType: Type.get(String), defaultValue: "" });
