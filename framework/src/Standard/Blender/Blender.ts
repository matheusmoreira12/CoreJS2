...
export namespace Blender {
    ...
    export function blend<TTarget, TBlend>(blendClass: ClassOf<TBlend>, targetObj: TTarget) {
    ...
    export function tryGet<TBlend, TSource>(blendClass: ClassOf<TBlend>, sourceObj: TSource, output: TryOutput<TBlend> = {}): boolean {
    ...
    export function get<TBlend, TSource>(blendClass: ClassOf<TBlend>, sourceObj: TSource): TBlend {
    ...
    export function tryInitialize<TBlend, TSource>(sourceObj: TSource, blendClass: ClassOf<TBlend>, output: TryOutput<TBlend>, ...constructorArgs: []): boolean {
        const storageTryGetOutput: TryOutput<BlendedInstanceInfo<TSource, TBlend>> = {};
        if (Storage.tryGet(blendClass, sourceObj, storageTryGetOutput)) {
            const info = <BlendedInstanceInfo<TSource, TBlend>>storageTryGetOutput.result;
    ...
    export function initialize<TBlend, TSource>(blendClass: ClassOf<TBlend>, sourceObj: TSource): TBlend {
    ...
    export function tryUnBlend<TBlend, TSource>(blendClass: ClassOf<TBlend>, sourceObj: TSource): boolean {
    ...
    export function deBlend<TBlend, TSource>(blendClass: ClassOf<TBlend>, sourceObj: TSource) {
    ...
    export function tryExecute<TBlend, TResult>(sourceObj: object, blendClass: ClassOf<TBlend>, predicate: ExecutePredicate<TBlend, TResult>, output: TryOutput<TResult>): TResult | undefined;
    export function tryExecute<TBlend, TResult, TThis>(sourceObj: object, blendClass: ClassOf<TBlend>, predicate: ExecutePredicate<TBlend, TResult, TThis>, thisArg: TThis, output: TryOutput<TResult>): TResult | undefined;
    export function tryExecute<TBlend, TResult = any, TThisArg = any>(sourceObj: object, blendClass: ClassOf<TBlend>, predicate: ExecutePredicate<TBlend, TResult, TThisArg>, thisArg?: TThisArg, output?: TryOutput<TResult>): boolean {
        output = output || {};
    ...
    export function execute<TBlend, TResult = any>(sourceObj: object, blendClass: ClassOf<TBlend>, predicate: ExecutePredicate<TBlend, TResult>): TResult;
    export function execute<TBlend, TResult = any, TThisArg = any>(sourceObj: object, blendClass: ClassOf<TBlend>, predicate: ExecutePredicate<TBlend, TResult, TThisArg>, thisArg?: TThisArg): TResult;
    export function execute<TBlend, TResult = any, TThisArg = any>(sourceObj: object, blendClass: ClassOf<TBlend>, predicate: ExecutePredicate<TBlend, TResult, TThisArg>, thisArg?: TThisArg): TResult {
