...
export class ControlAttribute extends DependencyObject {
    static nameProperty = DependencyProperty.registerAttached(Type.get(ControlAttribute), "name", new PropertyMetadata(Type.get(String), ""));
    ...
    static valueProperty = DependencyProperty.registerAttached(Type.get(ControlAttribute), "value", new PropertyMetadata(Type.get(String), ""));
