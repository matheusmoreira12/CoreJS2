...
type ElementCtorNameExclusions = typeof ELEMENT_CTOR_NAME_EXCLUSIONS[number];

type AllElements = { [K in Exclude<keyof (typeof globalThis), ElementCtorNameExclusions> as (typeof globalThis)[K] extends (typeof Element) ? K : never]: (typeof globalThis)[K] };
...
const ELEMENT_CTOR_NAME_EXCLUSIONS = ["Element", "HTMLElement", "SVGElement", "MathMLElement", "Audio", "Source", "Image", "Option", "opener"] as const;

const HTML_NAMESPACE_URI = "http://www.w3.org/1999/xhtml";
const SVG_NAMESPACE_URI = "http://www.w3.org/2000/svg";

const ELEMENT_CONSTRUCTOR_NAME_MAP: Map<keyof AllElements, { elementName: string, elementNamespaceURI?: string }> = new Map([
    // ["HTMLHtmlElement", { elementName: "html" }]
]);
