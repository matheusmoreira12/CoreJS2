...
export namespace DOMUtils {
    ...
    export function insertElementsAt(parent: Element, position: number, children: Iterable<Element>) {
        let p = position;
        for (let child of children) {
            insertElementAt(parent, p, child)
            p++;
        }
    }
    ...
    export function removeMany(parent: Element, children: Iterable<Element>) {
        for (let child of children)
